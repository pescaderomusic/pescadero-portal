          ...
          <div style={{ padding: '36px 40px' }}>
            ...
            <section style={{ marginBottom: 32 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                ...
                <IC title="Client">
                  <p style={il}><strong>{contract.client_name || 'Client'}</strong></p>
                  {contract.couple_names && <p style={il}>{contract.couple_names}</p>}
                  {contract.client_email && <p style={il}>{contract.client_email}</p>}
                  {contract.client_phone && <p style={il}>{contract.client_phone}</p>}
                </IC>
              </div>
            </section>
            ...
            <section style={{ marginBottom: 32 }}>
              ...
              <p style={{ margin: 0, fontSize: 12, color: '#8A9EAA', lineHeight: 1.6 }}>Travel is included within 60 miles of Provo, UT. Any travel beyond 60 miles will be noted as a travel fee in the payment schedule below.</p>
            </section>
            ...
            <section style={{ marginBottom: 32 }}>
              ...
              <p style={bt}>To give your event the preparation it deserves, all major event details are due no later than 14 days before your event date, unless otherwise agreed upon in writing. This includes:</p>
              ...
              <p style={{ ...bt, margin: 0 }}>Last-minute changes are always welcome when timing allows — we will do our best to accommodate.</p>
            </section>
            ...
            {!signed && (
              <div>
                ...
                <div style={{ background: '#faf7f3', border: '1.5px solid #DDD3BC', borderRadius: 10, padding: '16px 20px', marginBottom: 16 }}>
                  <p style={{ margin: 0, fontSize: 12, color: '#6A7E8E', lineHeight: 1.6 }}>By clicking below, you confirm you have read and agree to the terms of this service agreement. You will be directed to a secure Stripe payment page to submit your <strong>${Number(contract.deposit_amount || 0).toFixed(2)} deposit</strong>, which secures your event date.</p>
                </div>
