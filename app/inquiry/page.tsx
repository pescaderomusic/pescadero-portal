      ...
      <div class="fields" style="gap:10px;">
        <div style="background:#fff;border:1.5px solid #DDD3BC;border-radius:10px;padding:14px 16px;">
          ...
          <div style="display:flex;flex-direction:column;gap:8px;">
            <div style="display:flex;gap:10px;font-size:0.84rem;color:#1A2D3F;line-height:1.4;"><span style="color:#37A8B0;font-weight:700;flex-shrink:0;">\u2713</span><span>Full Day Coverage \u2014 Sound for ceremony, dinner, speeches, toasts, dancefloor, and send-off</span></div>
